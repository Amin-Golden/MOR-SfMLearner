...
class Fusion(object):
    ...
    def update_nomag(self, accel, gyro, ts=None):    # 3-tuples (x, y, z) for accel, gyro
        ...
        gx, gy, gz = gyro   #(radians(x) for x in gyro) # Units deg/s
        ...
        self.heading = degrees(atan2(self.q[1]*qself.q[2] + self.q[0]*self.q[3], 0.5 - self.q[2]*self.q[2] - self.q[3]*self.q[3]);
